-- TODO: Fix semanticTokensProvider highlighting
-- TODO: Fix git blame
-- TODO: Check what is luasnip and if it can be useful
-- TODO: Investigae clipboard weirdness
--[[
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					if client and client.server_capabilities.documentHighlightProvider then
						-- FIXME - Disable semantic tokens as it messes up gruvbox rust colorscheme
